...
def update_after_llm_explanation(df_updated_rft,updated_llm):
    ...
    doc_3=doc_2[['purch_doc_no_src_po', 'purch_doc_item_no_src_po', 'pr_no_src_po',
           ...
           'risk_score','updated_risk_level', 'model_flag','updated_main_risk_scenario', 'predicted_risks', 
                 'updated_sub_risk_1', 'updated_sub_risk_2','impact', 'updated_impact_1','updated_impact_2', 'updated_impact_3',
           'llm_refined_explanation','vendor_name_1',]]
    ...
    new_names = {
        ...
        "updated_main_risk_scenario": "main_risk_scenario","updated_sub_risk_1":'sub_risk_1',"updated_sub_risk_2":'sub_risk_2',
        'updated_impact_1':'impact_1','updated_impact_2':'impact_2','updated_impact_3':'impact_3',
    }
