...
FEAT_PO     = Path("Po_Invoice_Data/po_output_features_df_model_02_10.pkl")         # engineered features
MODEL_PKL   = Path("Po_Invoice_Data/po_gbdt_model_02_10.pkl")         # tuned model file
CV_REPORT   = Path("Po_Invoice_Data/po_cv_results_02_10.csv")            # param grid results
SCORING_OUT = Path("Po_Invoice_Data/po_scored_po_02_10.pkl")             # predictions file
...
print("✅ Baseline model saved:", MODEL_PKL)
