...
def ai_explanation_part_1(df_updated_final):
    ...
    **Why It Was Flagged**
    ...
    • <bullet 5 grounded strictly in SOURCE (e.g., Invoice amount or quantity exceeds PO )>
    • <bullet 6 grounded strictly in SOURCE (e.g., PO placed to blocked vendor )>
    • <bullet 7 grounded strictly in SOURCE (e.g., New vendor + high-value PO (≤30 days & ≥ ₹1 Cr) )>
    • <bullet 8 grounded strictly in SOURCE (e.g., PAN 4th char = 'P' with amount ≥ ₹1 Cr )>
    • <bullet 9 grounded strictly in SOURCE (e.g., Vendor missing KYC (Tax ID) )>
